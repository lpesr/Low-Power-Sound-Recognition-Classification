...
(X, Y) = dp.prepare_input_data(os.path.join(dirname, "Data/ESC-50-Compressed"), ["glass_breaking", "siren", "hand_saw"], 0.05, 0.5, 4) #"glass_breaking", "siren", "hand_saw", "vacuum_cleaner", "crackling_fire"
buffer = list(zip(X, Y))
X = np.array(X)
Y = np.array(Y)
